            ...
            <div class="indenteds"><ul>
                <?php
                    ...
                    foreach($chunked[0] as $value)
                    {
                        ...
                        echo '<a href="#" data-view-section="adult_prob_'.$value['problem_id_adult'].'" data-async="start/adult_prob/'.$value['problem_id_adult'].'" onClick"myheaderresize()"><li class="selectable arrow"><strong>'.$value['clinical_problem'].'</strong></li></a>';
                    }
                ?>
            </ul></div>
        </article>
