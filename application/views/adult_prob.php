            ...
            <ul>
                <?php
                    ...
                    foreach($chunked[0] as $value)
                    {
                        ...
                        echo '<li class="selectable"><a href="#'.strtolower(str_replace(" ","_",$value['clinical_problem'])).'" data-router="section" data-async="http://jkm50.user.srcf.net/ssc_app/start/adult_prob/'.strtolower(str_replace(" ","_",$value['clinical_problem'])).'.html"><strong>'.$value['clinical_problem'].'</strong></a></li>';
                    }
