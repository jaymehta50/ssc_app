<section id="adult_prob_<?php echo $one_adult_prob[0]['clinical_problem_id']; ?>" data-transition="slide" data-aside="features" class="drag">
        ...
        if(($_COOKIE['devwidth'] - 42) >= (strlen($problem_name['clinical_problem'].': '.$value['subprob']) * 5)) echo "<marquee behavior='alternate' scrollamount='2'>".$problem_name['clinical_problem'].': '.$value['subprob']."</marquee>";
