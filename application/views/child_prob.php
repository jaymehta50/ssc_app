            ...
            <div class="indenteds"><ul>
                <?php
                    ...
                    foreach($chunked[0] as $value)
                    {
                        ...
                        echo '<a href="#" data-view-section="child_prob_'.$value['problem_id'].'" data-async="start/child_prob/'.$value['problem_id'].'"><li class="selectable arrow"><strong>'.$value['clinical_problem'].'</strong></li></a>';
                    }
                ?>
            </ul></div>
        </article>
