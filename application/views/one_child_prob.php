<section id="child_prob_<?php echo $one_child_prob[0]['clinical_problem_id']; ?>" data-transition="slide" data-aside="features" class="drag">
        <header>
            <nav>
        ...
        <article id="one_child_prob" class="list scroll active">
            ...
            <div class="indenteds"><ul>
                <?php
                    ...
                    $i = 0;
                    foreach($one_child_prob as $value)
                    {
                        ...
                        echo '<a href="#" data-view-section="childprob_'.$value['clinical_problem_id'].'_subprob_'.$i.'"><li class="selectable arrow"><strong>'.$value['problem_subgroup'].'</strong></li></a>';
        ...
        foreach($subgroup_array as $value) {
            echo '<section id="childprob_'.$value['problem_id'].'_subprob_'.$value['subprob_no'].'" data-transition="slide" data-aside="features" class="drag">
        ...
        echo '</header><article id="subprob_'.$value['subprob_no'].'" class="list scroll active"><div class="indented"><ul>
            ...
            foreach($one_child_prob as $value2)
            {
                if($value['subprob']!=$value2['problem_subgroup']) continue;
                echo '<a href="#" data-view-section="child_condition_'.$value2['id'].'" data-async="start/child_condition/'.$value2['id'].'"><li class="selectable arrow"><strong>'.$value2['condition'].'</strong></li></a>';
            }   
