        ...
        <article id="my_notes" class="list indented scroll">
            <div id="my_notes_<?php echo $condition['id']; ?>">
                <ul id="list_my_notes_<?php echo $condition['id']; ?>">
                    <li><p>You are currently looking at your notes on:</p><div style="font-style:italic;text-align:center;margin:9px 0 10px 0;"><p>'.$condition['condition'].'</p></div><p>You can also see your notes for conditions with the same name below:</p><h2>My Notes</h2></li>';
<?php
